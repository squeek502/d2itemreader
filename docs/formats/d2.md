...
43 | 5 | Unknown
48 | 8 | Version of the item. See [the `version` field of the `d2item` struct](api.md#structd2item).
56 | 2 | Unknown
58 | 3 | Item location. See [the `locationID` field of the `d2item` struct](api.md#structd2item).
61 | 4 | Item equipped location. See [the `equippedID` field of the `d2item` struct](api.md#structd2item).
65 | 4 | Item position X coordinate
69 | 3 | Item position Y coordinate
72 | 1 | Unknown
73 | 3 | Panel containing the item. See [the `panelID` field of the `d2item` struct](api.md#structd2item).
...
143 | 7 | Item level
150 | 4 | Item rarity ID. See [the `rarity` field of the `d2item` struct](api.md#structd2item)
...
11 | ***<p>Only exists when the item is class specific</p>*** ID of the class-specific automagic affix the item has (see [the `automagicID` field of the `d2item` struct](api.md#structd2item))
3 | ***<p>Only exists when the item's rarity is low quality</p>*** ID of the low quality type of the item (see [the `lowQualityID` field of the `d2item` struct](api.md#structd2item))
3 | ***<p>Only exists when the item's rarity is superior/high quality</p>*** ID of the superior type of the item (see [the `superiorID` field of the `d2item` struct](api.md#structd2item))
11 | ***<p>Only exists when the item's rarity is magic</p>*** ID of the prefix type of the item (see [the `magicPrefix` field of the `d2item` struct](api.md#structd2item))
11 | ***<p>Only exists when the item's rarity is magic</p>*** ID of the suffix type of the item (see [the `magicSuffix` field of the `d2item` struct](api.md#structd2item))
12 | ***<p>Only exists when the item's rarity is set</p>*** ID of the set type of the item (see [the `setID` field of the `d2item` struct](api.md#structd2item))
12 | ***<p>Only exists when the item's rarity is unique</p>*** ID of the unique type of the item (see [the `uniqueID` field of the `d2item` struct](api.md#structd2item))
8 | ***<p>Only exists when the item's rarity is rare or crafted</p>*** ID of the first name of the item (see [the `nameID1` field of the `d2item` struct](api.md#structd2item))
8 | ***<p>Only exists when the item's rarity is rare or crafted</p>*** ID of the second name of the item (see [the `nameID2` field of the `d2item` struct](api.md#structd2item))
